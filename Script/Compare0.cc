void Compare0()
{
    ...
    auto file = TFile::Open(Form("/Users/xiongzheng/software/Hadr03/Root/Proton_BGO_%dGeV.root",energy[ii]));
    ...
    c1->SaveAs(Form("/Users/xiongzheng/software/Hadr03/Script/Proton_BGO_%dGeV.pdf",energy[ii]));
